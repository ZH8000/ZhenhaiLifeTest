 ...
 */
case class TestingResult(testingID: Long, capacityID: Int, capacity: Double, dxValue: Double, isCapacityOK: Boolean, isDXValueOK: Boolean, isLeakCurrentOK: Boolean, isOK: Boolean, timestamp: Long)
